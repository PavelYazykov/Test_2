...
class TestPatchSettingsBusinessAccount:
    ...
    @allure.description('поле business_accounting - значение True')
    ...
    @allure.description('поле business_accounting - значение False')
    ...
    @allure.description('поле business_accounting - значение Null')
    ...
    @allure.description('поле business_accounting - Неверный тип данных integer')
    ...
    @allure.description('поле business_accounting - Неверный тип данных string')
    ...
    @allure.description('поле business_accounting - Пустое поле')
    ...
    @allure.description('поле business_accounting - Пустое отсутствует')
    def test_07(self, auth_fixture):
        """Авторизация"""
        access_token = auth_fixture

        """Отправка запроса"""
        result = SettingsMethods.patch_settings_without_business_accounting(
            False, True, True, True,
            True, True, 2, None, access_token
        )
